        ...
        <div className="flex items-center gap-4">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href="https://www.linkedin.com/in/lakshya-jain-655bb8244/"
                  target="_blank"
                  className="text-muted-foreground hover:text-primary transition-colors"
                  prefetch={false}
                >
              ...
              <TooltipContent>
                <p>www.linkedin.com/in/lakshya-jain-655bb8244</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
